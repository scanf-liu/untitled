...
public class Calculate {
    ...
    //起点坐标
    private double ballXStart = 100;
    private double ballYStart = 100;
    //起始时间
    private final double startTime;
    //速度，单位/s
    private double speed = 100;
    //定义小球移动的弧度
    private double degree = 3.14 / 3;//初始弧度60°
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 300; i++) {
            System.out.println(Arrays.toString(calculate.locationMethod()));
            try {
